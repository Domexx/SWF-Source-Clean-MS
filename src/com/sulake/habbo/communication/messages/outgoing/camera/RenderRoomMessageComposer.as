package com.sulake.habbo.communication.messages.outgoing.camera
{
    ...
    public class RenderRoomMessageComposer implements IMessageComposer 
    {
        ...
        {
           var roomPlanesDataJsonObj:String;
            var dataStrJsonObj:String;
        ...
        public function assignBitmap(data: BitmapData):void
        {
            var bitmapEncoded:* = PNGEncoder.encode(data);

            this._array = [ bitmapEncoded ];
            return;
        }
